...
public class WholeOverallControllerTest {
    @Autowired
    private MockMvc mvc;
    ...
    public void queryAll() throws Exception {
        ...
        String uri = "/whole-machine/queryAll";
        headers.add("head", "");
    ...
    public void add() throws Exception {
        ...
        String uri = "/whole-machine/add";
        headers.add("head", "");
        // 添加参数
        JSONObject paramJsObj = new JSONObject();
        paramJsObj.put("wholeId", "1");
        ...
        paramJsObj.put("architecture", "dddd");
    ...
    public void deleteById() throws Exception {
        ...
        MultiValueMap<String, String> params = new LinkedMultiValueMap<String, String>();
        // 请求URI，controller中接口上写明的mapping，不加配置的“server.servlet.context-path”
        String uri = "/whole-machine/deleteBatch";
        headers.add("head", "");
        // 添加参数
        params.add("ids", "");
        MvcResult result = mvc.perform(MockMvcRequestBuilders.delete(uri).headers(headers).params(params)).andReturn();
        // 获取执行结果的状态
        int status = result.getResponse().getStatus();
        Assert.assertEquals("错误", 200, status);
    }
