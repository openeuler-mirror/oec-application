<template>
  <div style="height:100%;">
    ...
    <div class="state-table-main">
      <main-table :data="rowData" :total="total" :rowProps="{prop: 'architecture', label: '架构'}"></main-table>
    </div>
  </div>
</template>
...
import { getArchStatus } from '@/common/api/wholeStatus';
import StateCount from '../../state-count';
import MainTable from './main-table';
export default {
  name: 'stateWholeArchitecture',
