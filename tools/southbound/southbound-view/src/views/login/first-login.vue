      ...
      <el-form size="large" class="login-content-form" :model="formData" :rules="rules" ref="loginRef"
        @keyup.enter.native="loginBtn">
          <el-form-item prop="username">
              <el-input type="text" placeholder="请输入用户名" disabled v-model="formData.username"
          ...
          <el-form-item prop="rePassword">
              <el-input :type="reIsShowPassword ? 'text' : 'password'" placeholder="请再次输入密码"
                v-model="formData.rePassword" autocomplete="password">
                  <template #prefix>
                    <el-icon><Unlock /></el-icon>
                  </template>
                  <template #suffix>
