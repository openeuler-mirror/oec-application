  ...
  <div class="card-warpper">
    <el-card shadow="hover">
        ...
        <div class="filter-area d-flex">
          <div class="filter-area-right">
            <el-form-item label="搜索" style="width: 100%">
              <el-input @keyup.enter.native="queryList" :show-message="false" v-model="queryForm.keyword" placeholder="用户名、操作名称、详情" style="width: 100%">
                <template #suffix>
      ...
      <div class="table-main">
        <el-table :data="data" style="width: 100%" height="100%" :header-cell-style="{backgroundColor: '#f5f7fa', 'text-align':'center'}" :cell-style="{'text-align':'center'}" v-loading="loading" border>
